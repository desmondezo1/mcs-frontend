...
<div className="washroomWrapper mx-auto my-auto mt-[100px]">
        ...
        { category?.category_description ? (<CategoryDetail category={category}/>) : 
    (<>
        <div className="washroomText">
            <div className="text-wrapper">
                <h1 className="title">{category?.category_name ? category?.category_name: "WASHROOM"}</h1>
                {!category?.category_summary ?"":<p> {category?.category_summary}</p>}
