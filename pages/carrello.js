...
import { updateTotalPrice } from '../stores/mySlice.js';
import CartList from '../components/cartList/index.js';
...
const Cart = () => {
  ...
  return(
    <div>
      <div className="bg-black fixed w-full h-full top-0 opacity-50 ">
      </div>
