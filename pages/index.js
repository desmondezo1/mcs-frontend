      ...
      <main>
        <section className="d-flex" id={"sect0"}>
          ...
          <div className="d-flex justify-content-center align-items-center ">
            ...
            <span
              className={`${
                styles.arrow
              } ${"sect1-arrow animate__animated animate__bounce animate__delay-5s animate__repeat-3 3	"}`}
            >
              <Link href="#sect1">
        ...
        <section className={styles.partnersSection} id={"sect2"}>
          <div className={styles.partnersSectionWrapper}>
            <div className="row" style={{ marginBottom: 30 + "px" }}>
              ...
              <div className="col-8">
                ...
                dispenser di asciugamani in cotone e carta, distributori di
                sapone e carta igienica, sono solo alcune delle proposte
                confortevoli ed ecologiche che hanno reso oggi MCS un' azienda
                leader nel territorio siciliano. Dal 2007, dopo essersi
                affermata con questo servizio, MCS allarga le proprie conoscenze
                abbracciando così i settori detergenza, attrezzi di pulizia e
                carta monouso.
              </div>
            </div>
            <div className="row" style={{ marginBottom: 30 + "px" }}>
            ...
            <div className="row" style={{ marginBottom: 30 + "px" }}>
              ...
              <div className="col-8">
                ...
                un buon rimedio, ma affidarsi soprattutto ad una consulenza
                professionale e trasparente in qualsiasi momento, contando su
          ...
          <span
            className={`${
              styles.arrow
            } ${"sect3-arrow animate__animated animate__bounce animate__delay-5s animate__repeat-3 3	"}`}
          >
            <Link href="#sect3">
              <Image alt="arrow" src={downArrow} />
            </Link>
        ...
        <section className={styles.statsSection} id={"sect3"}>
          <VisibilitySensor onChange={visibiltySetter}>
            <div
              className={`${styles.statsSectionWrapper} ${"position-relative"}`}
            >
              <div className={styles.stat}>
                ...
                <span className={styles.statLabel}>NUOVI CLIENTI 2021</span>
              </div>
              ...
              <div className={styles.stat}>
                ...
                <span className={styles.statLabel}>SPEDIZIONI NEL 2021</span>
              </div>
              ...
              <div className={styles.stat}>
                ...
                <span className={styles.statLabel}>PRODOTTI NELLO SHOP</span>
              </div>
